...
class _Hydro(object):
    ...
    def __init__(self):
        ...
        x is inside radius, x + dx is outside radius. Volume of the shell
        is the volume of a sphere with the outside radius minus the volume
        of a sphere with the inside radius.
        """
